...
class SpiralTraversal {
    ...
    public String recursiveTraversal(int[][] arr) {
        ...
        return traversal(arr, 0, 0, RIGHT, new boolean[arr.length][arr[0].length],"");
    }
     ...
     * @return
     */
    public String traversal(int[][] arr, int row, int col, String direction, boolean[][] visited, String stringPath) {
